...
func (n *NetworkTransport) dialConn(target string, temp1 uint32, temp2 uint32) (*NetConn, error) {
...
func (n *NetworkTransport) GetConn(target string, temp1 uint32, temp2 uint32) (*NetConn, error) {
	/*n.connPoolLock.Lock()
